    ...
    <section class="bg-white text-center">
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-md-10">
              <h3 class="mb-4">Perusahaan Acrylic Dicky Laser merupakan perusahaan manufaktur terkemuka yang bergerak di bidang produksi lembaran akrilik, aksesoris akrilik, dan produk jadi berbahan dasar akrilik.</h3>
