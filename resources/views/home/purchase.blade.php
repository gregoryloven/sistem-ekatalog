...
@section('content')
    ...
    <section class="py-9 overflow-hidden text-center" data-zanim-timeline="{}" data-zanim-trigger="scroll">
      <div class="bg-holder overlay overlay-1" style="background-image:url(../assets/img/contacts_header.jpg);" data-parallax="data-parallax"></div>
      <!--/.bg-holder-->
      <div class="container">
                  ...
                  <form id="purchaseForm"  action="{{ url('purchase-request') }}" method="POST" class="mt-3">
                    <div class="row">
                      ...
                      <div class="col-12 mt-4">
                        <input class="form-control bg-white" type="text" name="no_telp_penerima" placeholder="No HP" required="required" />
                      </div>
                      <div class="col-12 mt-4">
                        <textarea class="form-control bg-white" rows="5" name="alamat_penerima" placeholder="Alamat Penerima" required="required"></textarea>
                      </div>
                      <div class="col-12 mt-4">
                        ...
                        <!-- Tombol Tambah Produk -->
                            <a id="addrow" class="btn" style="margin: 7px 0px; padding: 5px 10px; background-color: #007bff; color: white; font-size: 10px;">
                                <i class="fa fa-plus"></i> Tambah Produk
                            </a>
                        </div>
                      <div class="col-12 mt-4 d-flex justify-content-end"><button class="btn btn-primary" type="Submit"> <span class="text-white fw-semi-bold">Pesan</span></button></div>
                    </div>
                  </form>
                </div>
              </div>
